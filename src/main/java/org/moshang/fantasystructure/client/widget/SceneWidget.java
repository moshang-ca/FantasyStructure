...
public class SceneWidget extends WidgetGroup {
    ...
    @OnlyIn(Dist.CLIENT)
    protected PreviewDummyWorld dummyWorld;
    @Getter
    ...
    public void needCompileCache() {
        if (isRemote() && renderer != null) {
            FantasyStructure.LOGGER.info("Need cache compile");
    ...
    public final void createScene(Level world, boolean useFBOSceneRenderer) {
        ...
        core = new HashSet<>();
        dummyWorld = new PreviewDummyWorld(world);
    ...
    @OnlyIn(Dist.CLIENT)
    public PreviewDummyWorld getDummyWorld() {
        return dummyWorld;
    }
